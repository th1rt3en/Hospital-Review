...
public class DoctorDAO {
    ...
    private static final String SEARCH_STATEMENT = "SELECT * FROM doctor "
            + "WHERE First_Name LIKE ? AND Last_Name LIKE ? AND Gender LIKE ? AND Degree LIKE ?";
    private static final String SEARCH_RATE_COMMENT_STATEMENT = "SELECT * FROM doctor JOIN `Doctor-Comment` on ID = Doctor_ID "
            + "WHERE First_Name LIKE ? AND Last_Name LIKE ? AND Gender LIKE ? AND Degree LIKE ?";
